...
export const createAccount = async submission => dispatch => {
  ...
  let config = {
    method: 'post',
    url: 'https://basrv.dillontarr.com/api/users/create-account',
    data: {
    ...
    config = {
      method: 'get',
      url: 'https://basrv.dillontarr.com/api/users/user-details',
...
export const logIn = submission => dispatch => {
  let config = {
    method: 'post',
    url: 'https://basrv.dillontarr.com/api/auth',
    data: {
...
export const logOut = () => dispatch => {
  ...
  const config = {
    method: 'post',
    url: 'https://basrv.dillontarr.com/api/users/log-out',
    headers: { 'x-auth-token': token }};
...
export const updateLoginName = newLoginName => dispatch => {
  ...
  let config = {
    method: 'post',
    url: 'https://basrv.dillontarr.com/api/users/update-display-name',
    headers: { 'x-auth-token': token },
    data: {
