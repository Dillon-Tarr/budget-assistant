...
function AddIncomeButton(props) {
  ...
  return (<>
    ...
    <div name="addIncome" className="add-income-or-outgo">
      ...
      {values.incomeName && values.incomeName.length >= 1 && values.dollarsPerOccurrence && values.dollarsPerOccurrence >= 1 &&
      (values.isRecurring === "false"
      ||
      (values.isRecurring === "true" // eslint-disable-next-line
        &&
        (values.recurringType === "normal" && values.referencePeriod && values.referencePeriod !== "null" && values.multiplesOfPeriod && values.multiplesOfPeriod !== "" && values.multiplesOfPeriod >= 1 && values.multiplesOfPeriod <= 12) // eslint-disable-next-line
        ||
